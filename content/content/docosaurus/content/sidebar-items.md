...
A `doc` item sets an [implicit sidebar association](https://docusaurus.io/docs/sidebar/items#sidebar-association). Don't assign the same doc to multiple sidebars: change the type to `ref` instead.
...
Use the **[shorthand syntax](https://docusaurus.io/docs/sidebar/items#category-shorthand)** when you don't need customizations:
...
**[a-category-index-page.md](http://a-category-index-page.md)**
